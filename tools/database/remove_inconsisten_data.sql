...
mysql> delete FROM catalog_category_product WHERE category_id = 127 AND product_id = 2971;
...
mysql> delete FROM catalog_category_product WHERE category_id = 110 AND product_id = 3316;